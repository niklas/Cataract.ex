defmodule Cataract.TorrentFileTest do
  ...
  test "extract metadata from torrent file" do
    ...
    assert TorrentFile.meta(fs_src <> "/torrents/multiple.torrent") == %{
    ...
    assert TorrentFile.meta(fs_src <> "/torrents/single.torrent") == %{
      size_bytes: 73451,
  ...
  test "provides existance of files on disk" do
    ...
    torrent = fs_root <> "/torrents/multiple.torrent"
